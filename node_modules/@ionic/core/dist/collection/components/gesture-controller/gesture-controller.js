...
export class GestureController {
     ...
     */
    create(config) {
        return Promise.resolve(new GD(this, this.newID(), config.name, config.priority ? config.priority : 0, !!config.disableScroll));
    }
    /**
     * Creates a blocker that will block any other gesture events from firing. Set in the ion-gesture component.
     */
    createBlocker(opts = {}) {
        return new BD(this.newID(), this, opts.disable, !!opts.disableScroll);
    }
